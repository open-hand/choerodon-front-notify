...
@inject('AppState')
@observer
export default class SmsTemplateCreate extends Component {
      ...
      <Form className="c7n-mailtemplate-create-form">
        ...
        >
          {getFieldDecorator('businessType', {
            ...
            initialValue: MailTemplateStore.getCurrentDetail.businessType || undefined,
          })(
            <Select
        ...
        >
          {
            getFieldDecorator('smsContent', {
              ...
              initialValue: MailTemplateStore.getCurrentDetail.content || undefined,
            })(
